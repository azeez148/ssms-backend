...
from .routers import products, sales, purchases, stock, dashboard, home, attributes, categories, delivery_types
...
app.include_router(delivery_types.router, prefix="/api")
